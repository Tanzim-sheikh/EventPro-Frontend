          ...
          <div className="lg:w-2/5 bg-white rounded-2xl shadow-lg p-8 h-fit">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="flex-shrink-0 bg-[#f0f5e8] p-3 rounded-lg">
                  <svg className="h-6 w-6 text-[#8C9F6E]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">support@eventpro.com</p>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="flex justify-center gap-10">
                <a href="#" className="text-gray-400 hover:text-[#8C9F6E]">
            ...
            {submitted ? (
              <div className="text-center py-10">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#f0f5e8] mb-4">
                  <svg className="w-8 h-8 text-[#8C9F6E]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button 
                  ...
                  className="px-6 py-2 bg-[#8C9F6E] text-white rounded-md hover:bg-[#7a8c5e] transition"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <button 
                    ...
                    className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#8C9F6E] hover:bg-[#7a8c5e] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8C9F6E] transition"
                  >
                    {isSubmitting ? (
                      <>
                ...
                <p className="text-xs text-gray-500 text-center">
                  ...
                  <a href="#" className="text-[#8C9F6E] hover:underline">Privacy Policy</a> and{' '}
                  <a href="#" className="text-[#8C9F6E] hover:underline">Terms of Service</a>.
                </p>
              </form>
            )}
          </div>
