      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-white flex items-center justify-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-xs sm:text-sm text-[#5a6b47] max-w-xs mx-auto">
              Join us and start exploring amazing events
            </p>
          </div>
          ...
          <div className="bg-white border-2 border-[#8C9F6E] rounded-xl shadow-lg shadow-[#8C9F6E]/20 overflow-hidden">
            <div className="bg-[#f8faf5] p-4 sm:p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                {/* Name Field */}
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-[#5a6b47] mb-1 sm:mb-2">
                    Full Name
                  </label>
                  <input
                    id="name"
                ...
                {/* Email Field */}
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-[#5a6b47] mb-1 sm:mb-2">
                    Email Address
                  </label>
                  <input
                    id="email"
                ...
                {/* Password Field */}
                <div>
                  <label htmlFor="password" className="block text-sm font-medium text-[#5a6b47] mb-1 sm:mb-2">
                    Password
                  </label>
                  <div className="relative">
                    <input
              ...
              <div className="mt-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-[#f8faf5] text-[#5a6b47]">
                      Or sign up with
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-4 sm:mt-6 grid grid-cols-2 gap-3">
                  {/* Google Button */}
                  <button className="w-full inline-flex justify-center items-center py-2 sm:py-2.5 px-4 border border-[#dbe4d3] rounded-lg shadow-sm bg-white text-xs sm:text-sm font-medium text-[#5a6b47] hover:bg-gray-50 transition-all duration-200 transform hover:scale-105">
              ...
              <div className="mt-6 text-center text-xs sm:text-sm space-y-2">
                <p className="text-[#5a6b47]">
                  Already have an account?{' '}
                  <Link to="/auth/user/login" className="font-medium text-[#A3B886] hover:text-[#7a8c5e] transition-colors duration-200">
                    Login here
                  </Link>
                </p>
                <p className="text-[#5a6b47]">
                  Are you an organizer?{' '}
                  <Link to="/auth/organizer/signup" className="font-medium text-[#A3B886] hover:text-[#7a8c5e] transition-colors duration-200">
                    Sign up as Organizer
                  </Link>
                </p>
                <p className="text-[#5a6b47]">
