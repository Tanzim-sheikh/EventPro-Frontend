...
const UserLogin = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-white flex items-center justify-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-600">
              ...
              <Link 
                to="/auth/user/signup" 
                className="font-medium text-[#A3B886] hover:text-[#8C9F6E] transition-colors duration-200"
              >
                create a new account
              </Link>
            </p>
            ...
            <div className="bg-[#f8faf5] p-4 sm:p-6 md:p-8">
              ...
              <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      value={formData.email}
                      onChange={handleChange}
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8C9F6E] focus:border-[#8C9F6E] text-sm sm:text-base transition-colors duration-200"
                ...
                <div>
                  ...
                  <div className="mt-1 relative">
                    <input
                      ...
                      value={formData.password}
                      onChange={handleChange}
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 pr-10 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8C9F6E] focus:border-[#8C9F6E] text-sm sm:text-base transition-colors duration-200"
                ...
                <div className="flex justify-end">
                  <Link 
                    ...
                    className="text-xs sm:text-sm font-medium text-[#A3B886] hover:text-[#8C9F6E] transition-colors duration-200"
                  >
                    Forgot your password?
                  </Link>
                </div>
                ...
                <div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full py-3 px-4 bg-[#A3B886] hover:bg-[#8C9F6E] text-white font-medium rounded-lg shadow-md transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none text-sm sm:text-base"
                  >
                    {isLoading ? (
              ...
              <div className="mt-6 sm:mt-8">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-[#f8faf5] text-gray-500">
                      Or continue with
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-4 sm:mt-6 grid grid-cols-2 gap-3">
                  {/* Google Button */}
                  <button
                    className="w-full inline-flex justify-center items-center py-2 sm:py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-all duration-200 transform hover:scale-105"
                  >
                    <span className="sr-only">Sign in with Google</span>
                  ...
                  >
                    <span className="sr-only">Sign in with GitHub</span>
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fillRule="evenodd"
                        d="M10 0C4.477 0 0 4.484 0 10.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.603-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.268 2.75 1.025A9.564 9.564 0 0110 4.844c.85.004 1.705.114 2.504.336 1.909-1.293 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.933.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C17.14 18.17 20 14.44 20 10.017 20 4.484 15.522 0 10 0z"
                        clipRule="evenodd"
              ...
              <div className="mt-6 text-center">
                <p className="text-xs sm:text-sm text-gray-600">
                  Need help? <Link to="/contact" className="text-[#A3B886] hover:text-[#8C9F6E]">Contact support</Link>
                </p>
              </div>
            </div>
          </div>
