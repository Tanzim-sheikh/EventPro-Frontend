...
//                   <Link to="/auth/organizer/forgot-password" className="font-medium text-[#A3B886] hover:text-[#A3B886]">
            ...
            <div className="bg-[#f8faf5] p-4 sm:p-6 md:p-8">
              ...
              <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      value={formData.email}
                      onChange={handleChange}
                      className="w-full px-3 py-2 sm:py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8C9F6E] focus:border-[#8C9F6E] text-sm sm:text-base transition-colors duration-200"
                ...
                <div>
                  ...
                  <div className="mt-1 relative">
                    <input
                      ...
                      value={formData.password}
                      onChange={handleChange}
                      className="w-full px-3 py-2 sm:py-3 pr-10 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8C9F6E] focus:border-[#8C9F6E] text-sm sm:text-base transition-colors duration-200"
                ...
                <div className="flex justify-end">
                  <Link 
                    to="/auth/organizer/forgot-password" 
              ...
              <div className="mt-6 sm:mt-8">
                ...
                <div className="mt-4 sm:mt-6 grid grid-cols-2 gap-3">
                  {/* Google Button */}
                  <button
                    className="w-full inline-flex justify-center items-center py-2 sm:py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors duration-200"
                  >
                    <span className="sr-only">Sign in with Google</span>
