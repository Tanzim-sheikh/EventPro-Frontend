...
const OrganizerForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`${axios_url}/Organizer/OrganizerForgotPassword`, { email });
  ...
  const handleReset = async (e) => {
    ...
    try {
      const response = await axios.put(`${axios_url}/Organizer/OrganizerResetPassword`, { email, otp, newPassword });
